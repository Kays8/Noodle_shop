...
<body>
    ...
    $sql_select = 'select * from menu order by FoodTypeID';
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['FoodName'])) {
            ...
            $sql = "INSERT INTO food(FoodName,FoodPrice,FoodTypeID,FoodPhoto) VALUES (:FoodName,:FoodPrice,:FoodTypeID,:FoodPhoto)";
            ...
            $stmt->bindParam(':FoodPhoto',$uploadFile);
